...
!define OUTPUT_FILENAME "Output\${PRODUCT_NAME}-3.2.exe"
!define PRODUCT_PUBLISHER "blumind.org"
!define PRODUCT_WEB_SITE "http://www.blumind.org"
...
Function .onInit
	!insertmacro DotNetSearch 2 0 50727 "INSTALL_NOABORT" "http://www.blumind.org"
...
Section "MainSection" SEC01
	...
	SetOutPath "$INSTDIR"
	File "..\Code\Release\Blumind.exe"
	File "..\Code\Release\PdfSharp.dll"
	File "..\Documents\Blumind Quick Help.bmd"
	
	SetOutPath "$INSTDIR\Icons"
	File "Resources\Icons\*.png"
	File "Resources\Icons\readme.txt"
	
	SetShellVarContext all
	!define INSTDIR_DATA "$LOCALAPPDATA\${PRODUCT_NAME}"
	
	SetOutPath "${INSTDIR_DATA}\Languages"
	File "..\Code\Blumind\Resources\Languages\*.xml"
		
	SetOutPath "${INSTDIR_DATA}\UI Themes"
	File "..\Code\Blumind\Resources\UIThemes\*.xml"
...
Section -Post
	...
	WriteRegStr HKCR "Blumind.MindMap\DefaultIcon" "" "$INSTDIR\Blumind.exe,1"
