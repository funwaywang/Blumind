...
namespace Blumind.Controls.OS
{
    public static class WinMessages
    {
        ...
        public const int WM_KEYLAST = 0x0109; // _WIN32_WINNT >= 0x0501, 0x0108
        ...
        public const int WM_MOUSELAST = 0x020E; // _WIN32_WINNT >= 0x0600, 0x020E; _WIN32_WINNT >= 0x0500, 0x020D; _WIN32_WINNT >= 0x0400, 0x020A
